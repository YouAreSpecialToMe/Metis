...
if os.path.exists(os.path.join('softLabel', args.model_name)) == False:
    os.makedirs(os.path.join('softLabel', args.model_name))
x_arr = train_x[0]
for i in range(1, len(train_x)):
    x_arr = np.append(x_arr, train_x[i], axis=0)

np.save(file=os.path.join('softLabel', args.model_name,'train_x.npy'), arr=x_arr)
print(x_arr.shape)
...
np.save(file=os.path.join('softLabel', args.model_name,'train_label.npy'), arr=label_arr)
...
np.save(file=os.path.join('softLabel', args.model_name,'train_score.npy'), arr=score_arr)
...
np.save(file=os.path.join('softLabel', args.model_name,'test_x.npy'), arr=x_arr)
print(x_arr.shape)
...
np.save(file=os.path.join('softLabel', args.model_name,'test_label.npy'), arr=label_arr)
print(label_arr.shape)
...
np.save(file=os.path.join('softLabel', args.model_name,'test_score.npy'), arr=score_arr)
print(score_arr.shape)
